$(document).ready(function () {
    ...
    $.get('/messages')
        .done(function (res) {
            $.each(res, function (index, value) {
                ...
                console.log(value);
                if (value.user === 'Admin') {
                    $('.chat').append('<p class="item"><span class="Admin">' + value.user + ': </span><span class="msg">' + value.message + '</span></p>');
                } else {
    ...
    socket.on('message', function (data) {
        ...
        if (username === 'Admin') {
            $('.chat').append('<p class="item"><span class="Admin">' + username + ': </span><span class="msg">' + message + '</span></p>');
        } else {
